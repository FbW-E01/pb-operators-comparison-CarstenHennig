...
const eigthComparison = mangos == apples == oranges;
console.log("This comparison is obviously... " + eigthComparison);
...
const ninthComparison = apples%mangos === oranges%mangos;
console.log("This comparison is: " + ninthComparison);
...
console.log(mangos+apples >= oranges-mangos);
const tenthComparison = mangos+apples >= oranges-mangos;
console.log("This is: " + tenthComparison);
